...
if os.environ.get('UNIKP_MEDIA_PATH'):
    ...
    PROTT5XL_MODEL_PATH = '/home/saleh/webKinPred/models/UniKP-main/models/protT5_xl/prot_t5_xl_uniref50'
...
def main(input_path, output_path, task_type):
    ...
    if os.environ.get('UNIKP_MEDIA_PATH'):
        ...
        # Local environment
        model_path = F'/home/saleh/webKinPred/models/UniKP-main/models/UniKP_{task_type}.pkl'
